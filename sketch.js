...
function preload() {
  backgroundImg = loadImage("./assets/forest-game-background.jpg");
}
...
function draw() {
  if(gameState==0){
    background("yellow")
    text("WELCOME TO THE ARCHERY GAME",displayWidth/2,displayHeight/2)
...
function keyPressed() {
  if (keyCode === 32) {
    ...
    var arrow = new PlayerArrow(posX, posY, 200, 30, angle);
